...
"CoxeterGroupByCoxeterMatrix(C)"=>"coxgroup(cartan(C))",
"CoxeterGroupByCartanMatrix(C)"=>"coxgroup(C)",
...
"HeckeReflectionRepresentation"=>"reflrep or reflection_representation",
#HeckeSubAlgebra
...
"W.matgens"=>"reflrep(W) or reflection_representation",
"W.matgens[i]"=>"reflrep(W,i) or reflection_representation",
"MatStab"=>"stab_onmats",
"MatXPerm(W,p)"=>"reflrep(W,p) or reflection_representation",
"MatYPerm"=>"matY",
"Mod1"=>"modZ",
"MovedPoints"=>"support",
"Mvp(\"x\")"=>"Mvp(:x)",
