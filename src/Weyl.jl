...
@inline PermRoot.inclusion(W::WeylSubGroup)=W.G.inclusion
@inline @inbounds PermRoot.inclusion(W::WeylSubGroup,i)=W.G.inclusion[i]
@inline PermRoot.restriction(W::WeylSubGroup)=W.G.restriction
@inline @inbounds PermRoot.restriction(W::WeylSubGroup,i)=W.G.restriction[i]

"""
ReflectionSubGrup(W,I)
...
is used by 'ReflectionSubGroup' to determine the Coxeter system of `H`.
...
PermRoot.ReflectionSubGroup(W::WeylSubGroup,I::AbstractVector{Int})=
  ReflectionSubGroup(W.parent,inclusion(W)[I])

@inbounds CoxGroups.isleftdescent(W::WeylSubGroup,w,i::Int)=inclusion(W,i)^w>W.parent.N
