...
function Base.show(io::IO,d::Diagram,::Val{:G4})
  l,ind=getlind(d)
  println(io,cd(3),bar^2,cd(3),d.t);print(io,ind[1]," "^3,ind[2])
end
...
function Base.show(io::IO,d::Diagram,::Val{:G12})
  ...
  println(io," /4\\");println(io,cd(2),bar^2,cd(2))
...
function Base.show(io::IO,d::Diagram,::Val{:G13})
  ...
  println(io," / \\");println(io,cd(2),bar^2,cd(2))
...
function Base.show(io::IO,d::Diagram,::Val{:G14})
  l,ind=getlind(d)
  println(io,"  ₈");println(io,cd(2),bar,cd(3),d.t)
...
function Base.show(io::IO,d::Diagram,::Val{:G16})
  l,ind=getlind(d)
  println(io,cd(5),bar^2,cd(5),d.t);print(io,ind[1]," "^3,ind[2])
end
...
function Base.show(io::IO,d::Diagram,::Val{:G19})
  l,ind=getlind(d);f(arg...)=join(ind[collect(arg)])
  println(io," "^2,cd(3),ind[2]," ",d.t);println(io," /3\\");
  println(io,cd(2),bar^2,cd(5))
  print(io,ind[1]," "^3,ind[3]," ",f(1,2,3),"=",f(2,3,1),"=",f(3,1,2))
end

function Base.show(io::IO,d::Diagram,::Val{:G20})
  l,ind=getlind(d)
  println(io,"  ₅");println(io,cd(3),bar,cd(3),d.t)
  print(io,ind[1]," "^2,ind[2])
end
...
function Base.show(io::IO,d::Diagram,::Val{:G25})
  l,ind=getlind(d)
  println(io,cd(3),bar^2,cd(3),bar^2,cd(3),d.t)
  print(io,ind[1]," "^3,ind[2]," "^3,ind[3])
end

function Base.show(io::IO,d::Diagram,::Val{:G26})
  l,ind=getlind(d)
  println(io,cd(2),dbar^2,cd(3),bar^2,cd(3),d.t)
  print(io,ind[1]," "^3,ind[2]," "^3,ind[3])
end
...
function Base.show(io::IO,d::Diagram,::Val{:G29})
  ...
  println(io,"     /\u2016\\")
  print(io,cd(2),bar^2,cd(2),dbar^2,cd(2))
...
function Base.show(io::IO,d::Diagram,::Val{:G31})
  ...
  println(io,cd(2),bar^2, cd(2),bar^2, cd(2)," "^2,d.t)
  println(io," \\ /3\\ /")
  print(io," "^2,cd(2),bar^2,cd(2),"    i.e. A₅ on ")
...
function Base.show(io::IO,d::Diagram,::Val{:G32})
  l,ind=getlind(d)
  println(io,(cd(3)*bar^2)^3,cd(3),d.t)
...
function Base.show(io::IO,d::Diagram,::Val{:G33})
  ...
  println(io," "^5,"/^\\")
  println(io,(cd(2)*bar^2)^3,cd(2),"  ",f(4,2,3,4,2,3),"==",f(3,4,2,3,4,2))
...
function Base.show(io::IO,d::Diagram,::Val{:G34})
  ...
  println(io," "^5,"/^\\")
  println(io,(cd(2)*bar^2)^4,cd(2)," ",f(4,2,3,4,2,3),"==",f(3,4,2,3,4,2))
...
function Base.show(io::IO,d::Diagram,::Val{Symbol("E",Char(0x00303))})
  ...
  if length(v)==7
    print(io,"        ",v[7],"\n        |\n","        ",v[2],"\n        |\n",
          join(v[[1,3,4,5,6]],bar^3),"    ",d.t)
  elseif length(v)==8
    println(io,"            ",v[2],"\n            |")
    print(io,join(v[[8,1,3,4,5,6,7]],bar^3),"  ",d.t)
  elseif length(v)==9
    println("        ",v[2],"\n        |")
    print(io,join(v[[1,3,4,5,6,7,8,9]],bar^3),"  ",d.t)
  end
end

function Base.show(io::IO,d::Diagram,::Val{Symbol("F",Char(0x00303))})
  v=d.t.indices
  print(io,v[5],bar^3,v[1],bar^3,v[2],ldarrow(2),v[3],bar^3,v[4]," "^3,d.t)
end

function Base.show(io::IO,d::Diagram,::Val{Symbol("G",Char(0x00303))})
  v=d.t.indices
  print(io,v[3],bar^2,v[1],tarrow(2),v[2],"   ",d.t)
end
...
function impdiagram(io::IO,D::Diagram,p,q,r,ind)
  ...
  elseif q==2
    ...
    println(io,ind[1]," ",cd(d),"3",vbar," ",join(fill(cd(2),r-2),bar^2))
    print(io,indent,"    \\",vbar)
    if r>=3 print(io,"/") end
    println(io)
    ...
    println(io,join(fill(cd(2),r-2),bar^2))
    print(io,indent,"   \\ ")
    if r>=3 print(io,"/") end
    println(io)
