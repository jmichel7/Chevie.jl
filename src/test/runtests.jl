...
@test mytest("c=inv(1+E(4))","1//2-1//2E(4)")
@test mytest("typeof(c)","Cyc{Rational{Int64}}")
@test mytest("typeof(1+E(4))","Cyc{Int64}")
@test mytest("Cyc(1+im)","1+E(4)")
@test mytest("1//(1+E(4))","1//2-1//2E(4)")
@test mytest("typeof(Cyc(1//2))","Cyc{Rational{Int64}}")
@test mytest("conj(1+E(4))","1-E(4)")
@test mytest("c=E(9)","-E(9)^4-E(9)^7")
@test mytest("AsRootOfUnity(c)","1//9")
@test mytest("c=Complex(E(3))","-0.4999999999999998 + 0.8660254037844387im")
@test mytest("Cyc(c)","-0.4999999999999998+0.8660254037844387E(4)")
@test mytest("Cyc(c)","-0.4999999999999998+0.8660254037844387E(4)")
@test mytest("galois(1+E(4),-1)","1-E(4)")
@test mytest("galois(ER(5),2)==-ER(5)","true")
@test mytest("galois(ER(5),2)==-ER(5)","true")
@test mytest("ER(-3)","E(3)-E(3)^2")
