...
chevieset(:timp, :UnipotentCharacters, function (p, q, r, phi)
  if [p, q, r]==[3, 3, 3]
    ...
    :almostHarishChandra=>[Dict(:relativeType=>TypeIrred(;orbit=[
      ...
      Dict(:relativeType=>TypeIrred(;series=:A,indices=Int[],rank=0),:levi=>1:3,
    ...
    elseif order(phi)==4
     ...
     Dict(:relativeType=>TypeIrred(;series=:A,indices=Int[],rank=0),
       :levi=>1:3,:parameterExponents=>[],:charNumbers=>[7],
       :eigenvalue=>E(3,2), :cuspidalName => "{}^4G_{3,3,3}[\\zeta_3^2]"), 
     Dict(:relativeType=>TypeIrred(;series=:A,indices=Int[],rank=0),
       :levi => 1:3, :parameterExponents => [], :charNumbers => [8],
       :eigenvalue => E(3), :cuspidalName => "{}^4G_{3,3,3}[\\zeta_3]")],
     :almostHarishChandra=>[Dict{Symbol, Any}(:relativeType=>TypeIrred(;orbit=[
      TypeIrred(;series=:ST,indices=1:3,p=3,q=3,rank=3)],twist=perm"(1,2,3,4)"),
      :levi=>Int[],:eigenvalue=>1,:cuspidalName => "", :charNumbers => 1:6), 
     Dict(:relativeType=>TypeIrred(;series=:A,indices=Int[],rank=0),:levi=>1:3,
      :charNumbers=>[7],:eigenvalue=>E(3),:cuspidalName=>"G_{3,3,3}[\\zeta_3]"),
     Dict(:relativeType=>TypeIrred(;series=:A,indices=Int[],rank=0),:levi=>1:3,
