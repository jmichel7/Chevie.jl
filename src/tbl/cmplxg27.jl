...
chevieset(:G27,:AltPres,[
  ...
  Dict{Symbol,Any}(:gens=>[[3],[-3,2,3],[1]],
                   :rels=>[braidrel(1,3,3),braidrel(1,2,4),braidrel(2,3,5),
                           ([2,1,2,3,1,2,3],[1,2,3,1,2,3,1])])])

#[[1,3,-1],[1],[2]]
chevieset(:G27,:braid_relations,[braidrel(1,2,3),braidrel(1,3,3),braidrel(2,3,4),
...
chevieset(:G27, :classwords, map(x->
...
chevieset(:G27, :classinfo, Dict{Symbol, Any}(
  :classwords => chevieget(:G27, :classwords), 
...
chevieset(:G27,:sparse_fakedegrees,[[1,0],[1,45],[1,7,1,13,1,25],
