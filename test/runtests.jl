...
@test mytest("T=Tbasis(H)","(::getfield(Gapjm.Hecke, Symbol(\"#f#20\")){Int64,Perm{Int16},HeckeAlgebra{Int64,Gapjm.Weyl.FiniteCoxeterGroup{Int16,Int64}}}) (generic function with 4 methods)")
...
@test mytest("H=hecke(W,q^2,q)","Hecke(W(B₂),q²,q)")
@test mytest("[H.para,H.sqpara]","2-element Array{Array{T,1} where T,1}:\n Tuple{Pol{Int64},Pol{Int64}}[(q², -1), (q², -1)]\n Pol{Int64}[q, q]")
@test mytest("H=hecke(W,[q^2,q^4],[q,q^2])","Hecke(W(B₂),Pol{Int64}[q², q⁴],Pol{Int64}[q, q²])")
@test mytest("[H.para,H.sqpara]","2-element Array{Array{T,1} where T,1}:\n Tuple{Pol{Int64},Pol{Int64}}[(q², -1), (q⁴, -1)]\n Pol{Int64}[q, q²]")
@test mytest("H=hecke(W,9,3)","Hecke(W(B₂),9,3)")
...
@test mytest("T=Tbasis(H)","(::getfield(Gapjm.Hecke, Symbol(\"#f#20\")){Pol{Int64},Perm{Int16},HeckeAlgebra{Pol{Int64},Gapjm.Weyl.FiniteCoxeterGroup{Int16,Int64}}}) (generic function with 4 methods)")
