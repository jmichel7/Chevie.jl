...
const exclu=Dict(
 "BraidRelations"=>["imp"],
 "CartanMat"=>["B","D","G25","G26","G29","G31","G32","G34","imp"],
 "CharInfo"=>["I","imp"],
 "CharName"=>["timp"],
 "CharParams"=>["imp"],
 "CharSymbols"=>["imp"],
 "CharTable"=>["2A","B","D","2D","G31","G34","imp"],
 "ClassInfo"=>["imp"],
 "ClassName"=>["imp"],
 ...
 "FakeDegree"=>["2A","imp"],
 "FactorizedSchurElement"=>["G24","G27","G29","G33","G34","E6","E7","E8","H3","H4","imp"],
 "GeneratingRoots"=>["imp"],
 "gensMODA"=>["D"],
 "HeckeCharTable"=>["imp","2A","2D","B","D"],
 "HeckeRepresentation"=>["2D"],
 "HighestPowerFakeDegrees"=>["imp"],
 "Hk"=>["B","D"],
 "Invariants"=>["imp","E7", "E8", "H3", "H4"],
 "LowestPowerFakeDegrees"=>["imp"],
 "NrConjugacyClasses"=>["imp"],
 "ParabolicRepresentatives"=>["imp"],
 "PowerMaps"=>["imp"],
 ...
 "Representation"=>["2D"],
 "ReflectionDegrees"=>["imp"],
 "ReflectionName"=>["imp"],
 "SchurData"=>["imp"],
 "SchurElement"=>["D","G31","imp"],
 "SchurModel"=>["imp"],
 "SemisimpleRank"=>["imp"],
 "Size"=>["imp"],
 "SymbolToParameter"=>["I"],
