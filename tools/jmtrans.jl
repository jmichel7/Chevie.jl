...
const exclu=Dict(
 ...
 "Rep"=>["G4_22"],
 "Representation"=>["2D","G4_22"],
 "SchurData"=>["G4_22"],
 "SchurElement"=>["D","G31","G4_22"],
 "SchurModels"=>["G4_22"],
 "SymbolToParameter"=>["I"],
